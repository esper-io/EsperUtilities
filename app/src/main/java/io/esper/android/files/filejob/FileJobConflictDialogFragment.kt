...
import io.esper.android.files.coil.AppIconPackageName
import io.esper.android.files.compat.requireViewByIdCompat
import io.esper.android.files.databinding.FileJobConflictDialogViewBinding
import io.esper.android.files.file.FileItem
import io.esper.android.files.file.fileSize
import io.esper.android.files.file.formatShort
import io.esper.android.files.file.iconRes
import io.esper.android.files.file.lastModifiedInstant
import io.esper.android.files.filelist.appDirectoryPackageName
import io.esper.android.files.filelist.supportsThumbnail
import io.esper.android.files.provider.common.isEncrypted
...
import io.esper.android.files.util.shortAnimTime
import io.esper.android.files.util.showSoftInput
...
class FileJobConflictDialogFragment : AppCompatDialogFragment() {
    ...
    /** @see io.esper.android.files.filelist.FileListAdapter.onBindViewHolder */
