...
import io.esper.android.files.compat.obtainStyledAttributesCompat
import io.esper.android.files.compat.setTextAppearanceCompat
import io.esper.android.files.compat.use
import io.esper.android.files.databinding.NavigationDividerItemBinding
import io.esper.android.files.databinding.NavigationItemBinding
import io.esper.android.files.ui.AutoMirrorDrawable
import io.esper.android.files.ui.SimpleAdapter
import io.esper.android.files.util.getColorStateListByAttr
import io.esper.android.files.util.layoutInflater

class NavigationListAdapterBottom(
