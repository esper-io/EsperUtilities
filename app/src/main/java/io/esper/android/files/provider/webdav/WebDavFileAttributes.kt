...
import io.esper.android.files.provider.common.AbstractBasicFileAttributes
import io.esper.android.files.provider.common.BasicFileType
import io.esper.android.files.provider.common.EPOCH
import io.esper.android.files.provider.common.FileTimeParceler
import io.esper.android.files.provider.webdav.client.creationTime
import io.esper.android.files.provider.webdav.client.isDirectory
import io.esper.android.files.provider.webdav.client.isSymbolicLink
import io.esper.android.files.provider.webdav.client.lastModifiedTime
import io.esper.android.files.provider.webdav.client.size
